...
<body>
    ...
    <div class="body-inner">
        ...
        <div id="slider" class="inspiro-slider slider-fullscreen dots-creative" data-height-xs="360"
            ...
            <!-- Slide 1 -->
            <div class="slide" data-bg-video="homepages/corporate-v3/images/slider/Beach-Ball.mp4">
                <div class="container">
                    <div class="slide-captions text-center text-light">
                        <!-- Captions -->
                        <h2 class="text-dark text-lg-x2">INNOVATION</h2>
                        <p class="lead">Say hello to the smartest and most flexible bootstrap template. Polo is an
                            powerful template that can build any type of websites, and quite possibly the only one you
                            will ever need.</p>

                        <a class="btn btn-light btn-outline">Get in Touch</a>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="accordion toggle fancy clean accordion-transparent">
                            <div class="ac-item">
                                ...
                                <div class="ac-content" style="display: none;">Neque porro quisquam est, qui dolorem
                                    ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius
                                    modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</div>
                            </div>
                            <div class="ac-item">
        ...
        <!-- PARALLAX -->
        <section class="text-center text-light p-t-150 p-b-150" data-bg-parallax="images/parallax/2.jpg">
            ...
            <div class="container">
                ...
                <p class="lead">We offer a range of services for both businesses and individuals companies, Beautiful
                    nature, and rare feathers!. Morbi sagittis, sem quis lacinia faucibus, orci ipsum gravida tortor.
                </p>
        ...
        <!-- COUNTERS -->
        <section class="text-light p-t-150 p-b-150" data-bg-parallax="images/parallax/5.jpg">
            <div class="bg-overlay"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-3">
